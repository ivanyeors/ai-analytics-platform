...
const arrowForward = arrowForwardIcon;

// Chart types for the chart selector (used in the template)
const chartTypes = [
  { name: 'Bar Chart', icon: barChartIcon },
  { name: 'Line Chart', icon: lineChartIcon },
  { name: 'Pie Chart', icon: pieChartIcon },
  { name: 'Scatter Plot', icon: scatterChartIcon },
  { name: 'Area Chart', icon: areaChartIcon }
];
