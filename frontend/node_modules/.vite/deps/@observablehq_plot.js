...
function getGeoClip(geo2, context) {
  let cache, url;
  if (!(cache = geoClipCache.get(context)))
    geoClipCache.set(context, cache = /* @__PURE__ */ new WeakMap());
  if (geo2.type === "Sphere")
    geo2 = sphere;
...
var Rect = class extends Mark {
  ...
  render(index2, scales, channels, dimensions, context) {
    ...
    if ((X13 || X23) && !projection3 && isCollapsed(x3))
      X13 = X23 = null;
    if ((Y13 || Y23) && !projection3 && isCollapsed(y3))
      Y13 = Y23 = null;
